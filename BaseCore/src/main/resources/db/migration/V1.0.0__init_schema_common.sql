...
create table cm_user_relat (relator_seq bigint not null, targeter_seq bigint not null, cre_dt timestamp not null, creator_seq bigint not null, upd_dt timestamp not null, updator_seq bigint not null, del_yn varchar(1) not null, user_relat_cd varchar(35) not null, user_relat_dtl_val varchar(20), relat_aply_dt timestamp, targeter_agre_yn varchar(1) not null, targeter_agre_dt timestamp, primary key (relator_seq, targeter_seq));
