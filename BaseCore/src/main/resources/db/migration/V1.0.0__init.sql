...
(
	...
	PRNT_YN               VARCHAR(1)   DEFAULT  'N' NOT NULL ,
	PRNT_ORD              INTEGER  NOT NULL ,
	DEL_YN                VARCHAR(1)   DEFAULT  'N' NOT NULL ,
	CREATOR_SEQ           BIGINT  NOT NULL ,
	CRE_DT                TIMESTAMP  NOT NULL ,
...
(
	...
	MENU_DTL_METH_CD      VARCHAR(35)  NOT NULL ,
...
CREATE UNIQUE INDEX PK_CM_MENU_DTL ON CM_MENU_DTL
(MENU_DTL_SEQ  ASC);

ALTER TABLE CM_MENU_DTL
	ADD CONSTRAINT  PK_CM_MENU_DTL PRIMARY KEY (MENU_DTL_SEQ);
...
(MENU_DTL_SEQ  ASC, ROLE_SEQ ASC) ;



ALTER TABLE CM_MENU_DTL_ROLE_MAP
	ADD CONSTRAINT  PK_CM_MENU_DTL_ROLE_MAP PRIMARY KEY (MENU_DTL_SEQ, ROLE_SEQ);



CREATE INDEX IX_CM_MENU_DTL_ROLE_MAP ON CM_MENU_DTL_ROLE_MAP
(ROLE_SEQ  ASC);
...
COMMENT ON TABLE CM_MENU_DTL IS '공통 메뉴 상세';
COMMENT ON COLUMN CM_MENU_DTL.MENU_DTL_SEQ IS '메뉴 상세 순번';
COMMENT ON COLUMN CM_MENU_DTL.MENU_SEQ IS '메뉴 순번';
COMMENT ON COLUMN CM_MENU_DTL.MENU_DTL_PATH IS '메뉴 상세 경로';
COMMENT ON COLUMN CM_MENU_DTL.MENU_DTL_METH_CD IS '메뉴 상세 방법 코드';
COMMENT ON COLUMN CM_MENU_DTL.MENU_DTL_NM IS '메뉴 상세 명';
COMMENT ON COLUMN CM_MENU_DTL.MENU_DTL_DESC IS '메뉴 상세 설명';
COMMENT ON COLUMN CM_MENU_DTL.DEL_YN IS '삭제 여부';
COMMENT ON COLUMN CM_MENU_DTL.CREATOR_SEQ IS '생성자 순번';
COMMENT ON COLUMN CM_MENU_DTL.CRE_DT IS '생성 일시';
COMMENT ON COLUMN CM_MENU_DTL.UPDATOR_SEQ IS '수정자 순번';
COMMENT ON COLUMN CM_MENU_DTL.UPD_DT IS '수정 일시';
