...
create table cm_role (role_seq bigint not null, cre_dt timestamp not null, creator_seq bigint not null, def_page varchar(256), del_yn varchar(1) not null, role_desc varchar(2000), role_nm varchar(30), upd_dt timestamp not null, updator_seq bigint not null, primary key (role_seq));
