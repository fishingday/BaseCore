...
create table cm_critical_log (critical_log_seq bigint not null, http_status varchar(35), accept varchar(255), accept_charset varchar(255), accept_encoding varchar(255), accept_language varchar(255), cre_dt timestamp not null, req_uri varchar(2000) not null, param varchar(4000), referer varchar(255), req_ip varchar(20) not null, sess_id varchar(50), user_agent varchar(255), user_seq bigint, log_makr_cd varchar(35) not null, primary key (critical_log_seq));
