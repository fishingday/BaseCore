...
create table cm_menu (menu_seq bigint not null, cre_dt timestamp, creator_seq bigint, del_yn varchar(1) not null, icon_url varchar(255), menu_desc varchar(2000), menu_nm varchar(30) not null, menu_path varchar(255), prnt_ord integer not null, prnt_yn varchar(1) not null, up_menu_seq bigint, upd_dt timestamp, updator_seq bigint, menu_dtl_seq bigint not null, menu_dtl_desc varchar(2000), menu_dtl_meth_cd varchar(35) not null, menu_dtl_nm varchar(30) not null, menu_dtl_path varchar(255) not null, primary key (menu_dtl_seq));
...
create table cm_role_menu_map (menu_dtl_seq bigint not null, role_seq bigint not null, cre_dt timestamp, creator_seq bigint, del_yn varchar(1) not null, upd_dt timestamp, updator_seq bigint, menu_seq bigint not null, primary key (menu_seq, role_seq));
...
create table cm_user_bookmark (menu_seq bigint not null, role_seq bigint not null, user_seq bigint not null, cre_dt timestamp, creator_seq bigint, del_yn varchar(1), upd_dt timestamp, updator_seq bigint, primary key (menu_seq, role_seq, user_seq));
...
alter table cm_menu add constraint FKdupmew5y73fayt7wnx36bh0ja foreign key (menu_seq) references cm_menu;
...
alter table cm_role_menu_map add constraint FKoieo2toswx9hghnfjqhqec51x foreign key (menu_dtl_seq) references cm_menu;
