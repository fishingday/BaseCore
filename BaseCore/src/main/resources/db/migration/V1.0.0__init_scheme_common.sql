...
create table cm_important_log (important_log_seq bigint not null, accept varchar(255), accept_charset varchar(255), accept_encoding varchar(255), accept_language varchar(255), creator_dt timestamp not null, param varchar(4000), referer varchar(255), req_ip varchar(20) not null, sess_id varchar(50), user_agent varchar(255), user_seq bigint, write_makr_cd varchar(255) not null, primary key (important_log_seq));
