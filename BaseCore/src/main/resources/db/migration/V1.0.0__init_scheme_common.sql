...
create table cm_critical_log (critical_log_seq bigint not null, http_status varchar(35), accept varchar(255), accept_charset varchar(255), accept_encoding varchar(255), accept_language varchar(255), cre_dt timestamp not null, req_uri varchar(2000) not null, param varchar(4000), referer varchar(255), req_ip varchar(20) not null, sess_id varchar(50), user_agent varchar(255), user_seq bigint, write_makr_cd varchar(255) not null, primary key (critical_log_seq));
create table cm_cd_grp (grp_cd varchar(35) not null, cre_dt timestamp not null, creator_seq bigint not null, del_yn varchar(1) not null, grp_cd_desc varchar(2000), grp_cd_nm varchar(30) not null, upd_dt timestamp not null, updator_seq bigint not null, primary key (grp_cd));
create table cm_menu (menu_seq bigint not null, cm_scren_yn varchar(1) not null, cre_dt timestamp, creator_seq bigint, del_yn varchar(1) not null, icon_info varchar(255), menu_desc varchar(2000), menu_nm varchar(30) not null, menu_path varchar(255), prnt_ord integer not null, prnt_yn varchar(1) not null, up_menu_seq bigint, upd_dt timestamp, updator_seq bigint, primary key (menu_seq));
create table cm_org (org_seq bigint not null, cre_dt timestamp, creator_seq bigint, del_yn varchar(1) not null, org_desc varchar(2000), org_nm varchar(30) not null, prnt_ord integer not null, up_org_seq bigint, upd_dt timestamp, updator_seq bigint, primary key (org_seq));
...
create table cm_role (role_seq bigint not null, cre_dt timestamp not null, creator_seq bigint not null, def_page varchar(256), del_yn varchar(1) not null, role_cd varchar(35) not null, role_desc varchar(2000), role_nm varchar(30), upd_dt timestamp not null, updator_seq bigint not null, primary key (role_seq));
...
create table cm_org_user_map (org_seq bigint not null, user_seq bigint not null, cre_dt timestamp, creator_seq bigint, del_yn varchar(1) not null, upd_dt timestamp, updator_seq bigint, primary key (org_seq, user_seq));
alter table cm_role add constraint UK_ORGCD4 unique (role_cd);
alter table cm_user add constraint UK_LOGIN_ID unique (login_id);
alter table cm_cd_dtl add constraint FK_CDDTL2CDGRP foreign key (grp_cd) references cm_cd_grp;
alter table cm_menu_dtl add constraint FK_MENUDTL2MENU foreign key (menu_seq) references cm_menu;
alter table cm_menu_dtl_role_map add constraint FK_MENUDTLROLEMAP2MENUDTL foreign key (menu_dtl_seq) references cm_menu_dtl;
alter table cm_menu_dtl_role_map add constraint FK_MENUDTLROLEMAP2ROLE foreign key (role_seq) references cm_role;
alter table cm_noti_user_map add constraint FK_NOTIUSERMAP2NOTI foreign key (noti_seq) references cm_noti;
alter table cm_noti_user_map add constraint FK_NOTIUSERMAP2USER foreign key (user_seq) references cm_user;
alter table cm_role_menu_map add constraint FK_ROLEMENUMAP2MENU foreign key (menu_seq) references cm_menu;
alter table cm_role_menu_map add constraint FK_ROLEMENUMAP2ROLE foreign key (role_seq) references cm_role;
alter table cm_user_alow_ip add constraint FK_USERALOWIP2USER foreign key (user_seq) references cm_user;
alter table cm_user_bookmark add constraint FK_USERBOOKMARK2MENU foreign key (menu_seq) references cm_menu;
alter table cm_user_bookmark add constraint FK_USERBOOKMARK2ROLE foreign key (role_seq) references cm_role;
alter table cm_user_bookmark add constraint FK_USERBOOKMARK2USER foreign key (user_seq) references cm_user;
alter table cm_user_pwd add constraint FK_USERPWD2USER foreign key (user_seq) references cm_user;
alter table cm_user_role_map add constraint FK_USERROLEMAP2ROLE foreign key (role_seq) references cm_role;
alter table cm_user_role_map add constraint FK_USERROLEMAP2USER foreign key (user_seq) references cm_user;
alter table cm_org_user_map add constraint FK_ORGUSERMAP2ORG foreign key (org_seq) references cm_org;
alter table cm_org_user_map add constraint FK_ORGUSERMAP2USER foreign key (user_seq) references cm_user;