...
create table cm_cd_dtl (cd varchar(35) not null, grp_cd varchar(35) not null, cd_nm varchar(30) not null, cd_desc varchar(2000), cre_dt timestamp, creator_seq bigint, del_yn varchar(1) not null, opt_1 varchar(256), opt_2 varchar(256), opt_3 varchar(256), opt_4 varchar(256), opt_5 varchar(256), prnt_ord integer not null, upd_dt timestamp, updator_seq bigint, primary key (cd, grp_cd));
create table cm_grp_cd (grp_cd varchar(35) not null, cre_dt timestamp, creator_seq bigint, del_yn varchar(1) not null, grp_cd_desc varchar(2000), grp_cd_nm varchar(30), upd_dt timestamp, updator_seq bigint, primary key (grp_cd));
...
create table cm_menu_dtl (menu_dtl_seq bigint not null, cre_dt timestamp, creator_seq bigint, del_yn varchar(1) not null, http_method_cd varchar(35) not null, menu_dtl_desc varchar(2000), menu_dtl_nm varchar(30) not null, menu_dtl_path varchar(255) not null, menu_seq bigint not null, upd_dt timestamp, updator_seq bigint, primary key (menu_dtl_seq));
...
create table cm_noti_user_map (noti_user_map_seq bigint not null, close_yn varchar(1) not null, cre_dt timestamp not null, creator_seq bigint not null, del_yn varchar(1) not null, noti_seq bigint, qry_dt timestamp, send_media_typ_cd varchar(35) not null, upd_dt timestamp not null, updator_seq bigint not null, user_seq bigint, view_cnt integer not null, primary key (noti_user_map_seq));
create table cm_role (role_seq bigint not null, cre_dt timestamp, creator_seq bigint, del_yn varchar(1) not null, role_cd varchar(35) not null, role_desc varchar(2000), role_nm varchar(30), upd_dt timestamp, updator_seq bigint, primary key (role_seq));
...
create table cm_user (user_seq bigint not null, acunt_exp_dt date, cre_dt timestamp, creator_seq bigint, del_yn varchar(1) not null, last_login_ip varchar(23), login_dt timestamp, login_fail_cnt integer, login_id varchar(255) not null, upd_dt timestamp, updator_seq bigint, user_nm varchar(30), user_stat_cd varchar(35), user_tel_no varchar(20), primary key (user_seq));
