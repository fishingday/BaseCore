...
create sequence seq_cm_important_log start with 1000 increment by 1;
...
create table cm_important_log (important_log_seq bigint not null, accept varchar(255), accept_charset varchar(255), accept_encoding varchar(255), accept_language varchar(255), cre_dt timestamp not null, param varchar(4000), referer varchar(255), req_ip varchar(20) not null, sess_id varchar(50), user_agent varchar(255), user_seq bigint, write_makr_cd varchar(255) not null, primary key (important_log_seq));
...
create table cm_user_acces_log (user_acces_log_seq bigint not null, accept varchar(255), accept_charset varchar(255), acces_log_typ_cd varchar(255), cre_dt timestamp, http_method_cd varchar(255) not null, param varchar(4000), referer varchar(255), req_ip varchar(20) not null, req_url varchar(255) not null, sess_id varchar(50), user_agent varchar(255), primary key (user_acces_log_seq));
