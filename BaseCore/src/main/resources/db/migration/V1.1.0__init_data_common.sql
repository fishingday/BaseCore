-- 조직
INSERT INTO CM_ORG(ORG_SEQ, UP_ORG_SEQ, ORG_NM, ORG_DESC, PRNT_ORD, DEL_YN, CRE_DT, CREATOR_SEQ, UPD_DT, UPDATOR_SEQ)
VALUES (100, NULL, 'PARKS', 'PARKS', 1, 'N', NOW(), 100, NOW(), 100);
INSERT INTO CM_ORG(ORG_SEQ, UP_ORG_SEQ, ORG_NM, ORG_DESC, PRNT_ORD, DEL_YN, CRE_DT, CREATOR_SEQ, UPD_DT, UPDATOR_SEQ)
VALUES (101, 100, '신림동', '관악구 신림동', 1, 'N', NOW(), 100, NOW(), 100);
INSERT INTO CM_ORG(ORG_SEQ, UP_ORG_SEQ, ORG_NM, ORG_DESC, PRNT_ORD, DEL_YN, CRE_DT, CREATOR_SEQ, UPD_DT, UPDATOR_SEQ)
VALUES (102, 100, '북가좌동', '서대문구 북가좌동', 2, 'N', NOW(), 100, NOW(), 100);
INSERT INTO CM_ORG(ORG_SEQ, UP_ORG_SEQ, ORG_NM, ORG_DESC, PRNT_ORD, DEL_YN, CRE_DT, CREATOR_SEQ, UPD_DT, UPDATOR_SEQ)
VALUES (200, NULL, 'SUNGS', '서초구', 2, 'N', NOW(), 100, NOW(), 100);
INSERT INTO CM_ORG(ORG_SEQ, UP_ORG_SEQ, ORG_NM, ORG_DESC, PRNT_ORD, DEL_YN, CRE_DT, CREATOR_SEQ, UPD_DT, UPDATOR_SEQ)
VALUES (300, NULL, 'KIMS', '인천시 계양구', 3, 'N', NOW(), 100, NOW(), 100);
...
INSERT INTO CM_ROLE(ROLE_SEQ, ROLE_CD, ROLE_NM, DEF_PAGE, ROLE_DESC, DEL_YN, CRE_DT, CREATOR_SEQ, UPD_DT, UPDATOR_SEQ)
VALUES(103, 'ROLE_BENEFIT', '수혜자', '/dashboard/user', '사용자', 'N', NOW(), 100, NOW(), 100);
INSERT INTO CM_ROLE(ROLE_SEQ, ROLE_CD, ROLE_NM, DEF_PAGE, ROLE_DESC, DEL_YN, CRE_DT, CREATOR_SEQ, UPD_DT, UPDATOR_SEQ)
VALUES(104, 'ROLE_PAYER', '지불자', '/dashboard/user', '사용자', 'N', NOW(), 100, NOW(), 100);
...
VALUES (101, 'admin', '어드민', 'ENABLED', '010-1234-5678', NOW() + 365, 0, 'N', NOW(), 100, NOW(), 100);
INSERT INTO CM_USER(USER_SEQ, LOGIN_ID, USER_NM, USER_STAT_CD, USER_TEL_NO, ACUNT_EXP_DT, LOGIN_FAIL_CNT, DEL_YN, CRE_DT, CREATOR_SEQ, UPD_DT, UPDATOR_SEQ)
VALUES (102, 'manager', '관리자', 'ENABLED', '010-1234-5678', NOW() + 365, 0, 'N', NOW(), 100, NOW(), 100);
INSERT INTO CM_USER(USER_SEQ, LOGIN_ID, USER_NM, USER_STAT_CD, USER_TEL_NO, ACUNT_EXP_DT, LOGIN_FAIL_CNT, DEL_YN, CRE_DT, CREATOR_SEQ, UPD_DT, UPDATOR_SEQ)
VALUES (103, 'user01', '사용자01', 'ENABLED', '010-1234-5678', NOW() + 365, 0, 'N', NOW(), 100, NOW(), 100);
INSERT INTO CM_USER(USER_SEQ, LOGIN_ID, USER_NM, USER_STAT_CD, USER_TEL_NO, ACUNT_EXP_DT, LOGIN_FAIL_CNT, DEL_YN, CRE_DT, CREATOR_SEQ, UPD_DT, UPDATOR_SEQ)
VALUES (104, 'user02', '사용자02', 'ENABLED', '010-1234-5678', NOW() + 365, 0, 'N', NOW(), 100, NOW(), 100);
...
INSERT INTO CM_USER_ROLE_MAP(ROLE_SEQ, USER_SEQ, PRNT_ORD, DEL_YN, CRE_DT, CREATOR_SEQ, UPD_DT, UPDATOR_SEQ)
VALUES(104, 102, 1, 'N', NOW(), 100, NOW(), 100);
INSERT INTO CM_USER_ROLE_MAP(ROLE_SEQ, USER_SEQ, PRNT_ORD, DEL_YN, CRE_DT, CREATOR_SEQ, UPD_DT, UPDATOR_SEQ)
VALUES(102, 103, 1, 'N', NOW(), 100, NOW(), 100);
INSERT INTO CM_USER_ROLE_MAP(ROLE_SEQ, USER_SEQ, PRNT_ORD, DEL_YN, CRE_DT, CREATOR_SEQ, UPD_DT, UPDATOR_SEQ)
VALUES(103, 103, 1, 'N', NOW(), 100, NOW(), 100);
INSERT INTO CM_USER_ROLE_MAP(ROLE_SEQ, USER_SEQ, PRNT_ORD, DEL_YN, CRE_DT, CREATOR_SEQ, UPD_DT, UPDATOR_SEQ)
VALUES(102, 104, 1, 'N', NOW(), 100, NOW(), 100);
INSERT INTO CM_USER_ROLE_MAP(ROLE_SEQ, USER_SEQ, PRNT_ORD, DEL_YN, CRE_DT, CREATOR_SEQ, UPD_DT, UPDATOR_SEQ)
VALUES(103, 104, 1, 'N', NOW(), 100, NOW(), 100);

-- 조직 사용자
INSERT INTO CM_ORG_USER_MAP(ORG_SEQ, USER_SEQ, DEL_YN, CRE_DT, CREATOR_SEQ, UPD_DT, UPDATOR_SEQ)
VALUES (100, 102, 'N', NOW(), 100, NOW(), 100);
INSERT INTO CM_ORG_USER_MAP(ORG_SEQ, USER_SEQ, DEL_YN, CRE_DT, CREATOR_SEQ, UPD_DT, UPDATOR_SEQ)
...
INSERT INTO CM_MENU (MENU_SEQ, UP_MENU_SEQ, MENU_PATH, MENU_NM, MENU_DESC, CM_SCREN_YN, PRNT_YN, PRNT_ORD, DEL_YN, CRE_DT, CREATOR_SEQ, UPD_DT, UPDATOR_SEQ) VALUES (2000, null, null, '용돈', '용돈', 'N', 'Y', 2, 'N', NOW(), 100, NOW(), 100);
INSERT INTO CM_MENU (MENU_SEQ, UP_MENU_SEQ, MENU_PATH, MENU_NM, MENU_DESC, CM_SCREN_YN, PRNT_YN, PRNT_ORD, DEL_YN, CRE_DT, CREATOR_SEQ, UPD_DT, UPDATOR_SEQ) VALUES (2010, 2000, '/money/active_item', '아이템', '아이템', 'N', 'Y', 1, 'N', NOW(), 100, NOW(), 100);
INSERT INTO CM_MENU (MENU_SEQ, UP_MENU_SEQ, MENU_PATH, MENU_NM, MENU_DESC, CM_SCREN_YN, PRNT_YN, PRNT_ORD, DEL_YN, CRE_DT, CREATOR_SEQ, UPD_DT, UPDATOR_SEQ) VALUES (2020, 2000, '/money/exchange', '교환', '교환', 'N', 'Y', 2, 'N', NOW(), 100, NOW(), 100);
INSERT INTO CM_MENU (MENU_SEQ, UP_MENU_SEQ, MENU_PATH, MENU_NM, MENU_DESC, CM_SCREN_YN, PRNT_YN, PRNT_ORD, DEL_YN, CRE_DT, CREATOR_SEQ, UPD_DT, UPDATOR_SEQ) VALUES (2030, 2000, '/money/history', '이력', '이력', 'N', 'Y', 3, 'N', NOW(), 100, NOW(), 100);
INSERT INTO CM_MENU (MENU_SEQ, UP_MENU_SEQ, MENU_PATH, MENU_NM, MENU_DESC, CM_SCREN_YN, PRNT_YN, PRNT_ORD, DEL_YN, CRE_DT, CREATOR_SEQ, UPD_DT, UPDATOR_SEQ) VALUES (2040, 2000, '/money/item_mgt', '항목관리', '항목관리', 'N', 'Y', 4, 'N', NOW(), 100, NOW(), 100);
INSERT INTO CM_MENU (MENU_SEQ, UP_MENU_SEQ, MENU_PATH, MENU_NM, MENU_DESC, CM_SCREN_YN, PRNT_YN, PRNT_ORD, DEL_YN, CRE_DT, CREATOR_SEQ, UPD_DT, UPDATOR_SEQ) VALUES (2050, 2000, '/money/payment', '정산', '정산', 'N', 'Y', 5, 'N', NOW(), 100, NOW(), 100);
INSERT INTO CM_MENU (MENU_SEQ, UP_MENU_SEQ, MENU_PATH, MENU_NM, MENU_DESC, CM_SCREN_YN, PRNT_YN, PRNT_ORD, DEL_YN, CRE_DT, CREATOR_SEQ, UPD_DT, UPDATOR_SEQ) VALUES (2060, 2000, '/money/calhistory', '계산이력', '계산이력', 'N', 'Y', 6, 'N', NOW(), 100, NOW(), 100);
...
INSERT INTO CM_ROLE_MENU_MAP(ROLE_SEQ, MENU_SEQ, DEL_YN, CRE_DT, CREATOR_SEQ, UPD_DT, UPDATOR_SEQ) VALUES (103, 2010, 'N', NOW(), 100, NOW(), 100);
INSERT INTO CM_ROLE_MENU_MAP(ROLE_SEQ, MENU_SEQ, DEL_YN, CRE_DT, CREATOR_SEQ, UPD_DT, UPDATOR_SEQ) VALUES (103, 2020, 'N', NOW(), 100, NOW(), 100);
INSERT INTO CM_ROLE_MENU_MAP(ROLE_SEQ, MENU_SEQ, DEL_YN, CRE_DT, CREATOR_SEQ, UPD_DT, UPDATOR_SEQ) VALUES (103, 2030, 'N', NOW(), 100, NOW(), 100);
INSERT INTO CM_ROLE_MENU_MAP(ROLE_SEQ, MENU_SEQ, DEL_YN, CRE_DT, CREATOR_SEQ, UPD_DT, UPDATOR_SEQ) VALUES (104, 2040, 'N', NOW(), 100, NOW(), 100);
INSERT INTO CM_ROLE_MENU_MAP(ROLE_SEQ, MENU_SEQ, DEL_YN, CRE_DT, CREATOR_SEQ, UPD_DT, UPDATOR_SEQ) VALUES (104, 2050, 'N', NOW(), 100, NOW(), 100);
INSERT INTO CM_ROLE_MENU_MAP(ROLE_SEQ, MENU_SEQ, DEL_YN, CRE_DT, CREATOR_SEQ, UPD_DT, UPDATOR_SEQ) VALUES (104, 2060, 'N', NOW(), 100, NOW(), 100);
