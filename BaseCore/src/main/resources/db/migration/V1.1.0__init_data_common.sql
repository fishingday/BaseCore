...
VALUES (101, 'admin@coredevice.co.kr', '어드민', 'ENABLED', '010-1234-5678', NOW() + 365, 0, 'N', NOW(), 100, NOW(), 100);
INSERT INTO CM_USER(USER_SEQ, LOGIN_ID, USER_NM, USER_STAT_CD, USER_TEL_NO, ACUNT_EXP_DT, LOGIN_FAIL_CNT, DEL_YN, CRE_DT, CREATOR_SEQ, UPD_DT, UPDATOR_SEQ)
VALUES (102, 'manager@coredevice.co.kr', '관리자', 'ENABLED', '010-1234-5678', NOW() + 365, 0, 'N', NOW(), 100, NOW(), 100);
INSERT INTO CM_USER(USER_SEQ, LOGIN_ID, USER_NM, USER_STAT_CD, USER_TEL_NO, ACUNT_EXP_DT, LOGIN_FAIL_CNT, DEL_YN, CRE_DT, CREATOR_SEQ, UPD_DT, UPDATOR_SEQ)
VALUES (103, 'user01@coredevice.co.kr', '사용자01', 'ENABLED', '010-1234-5678', NOW() + 365, 0, 'N', NOW(), 100, NOW(), 100);
INSERT INTO CM_USER(USER_SEQ, LOGIN_ID, USER_NM, USER_STAT_CD, USER_TEL_NO, ACUNT_EXP_DT, LOGIN_FAIL_CNT, DEL_YN, CRE_DT, CREATOR_SEQ, UPD_DT, UPDATOR_SEQ)
VALUES (104, 'user02@coredevice.co.kr', '사용자02', 'ENABLED', '010-1234-5678', NOW() + 365, 0, 'N', NOW(), 100, NOW(), 100);
