...
-- 역할
INSERT INTO CM_ROLE(ROLE_SEQ, ROLE_CD, ROLE_NM, DEF_PAGE, ROLE_DESC, DEL_YN, CRE_DT, CREATOR_SEQ, UPD_DT, UPDATOR_SEQ) VALUES(100, 'ROLE_ADMIN',   '어드민', '/dashboard/admin',   '어드민', 'N', NOW(), 100, NOW(), 100);
INSERT INTO CM_ROLE(ROLE_SEQ, ROLE_CD, ROLE_NM, DEF_PAGE, ROLE_DESC, DEL_YN, CRE_DT, CREATOR_SEQ, UPD_DT, UPDATOR_SEQ) VALUES(101, 'ROLE_MANAGER', '관리자', '/dashboard/manager', '관리자', 'N', NOW(), 100, NOW(), 100);
INSERT INTO CM_ROLE(ROLE_SEQ, ROLE_CD, ROLE_NM, DEF_PAGE, ROLE_DESC, DEL_YN, CRE_DT, CREATOR_SEQ, UPD_DT, UPDATOR_SEQ) VALUES(102, 'ROLE_USER',    '사용자', '/dashboard/user',    '사용자', 'N', NOW(), 100, NOW(), 100);
INSERT INTO CM_ROLE(ROLE_SEQ, ROLE_CD, ROLE_NM, DEF_PAGE, ROLE_DESC, DEL_YN, CRE_DT, CREATOR_SEQ, UPD_DT, UPDATOR_SEQ) VALUES(103, 'ROLE_CHECKER', '확인자', '/dashboard/checker', '확인자', 'N', NOW(), 100, NOW(), 100);
INSERT INTO CM_ROLE(ROLE_SEQ, ROLE_CD, ROLE_NM, DEF_PAGE, ROLE_DESC, DEL_YN, CRE_DT, CREATOR_SEQ, UPD_DT, UPDATOR_SEQ) VALUES(104, 'ROLE_ACTOR',   '실행자', '/dashboard/actor',   '실행자', 'N', NOW(), 100, NOW(), 100);
...
INSERT INTO CM_USER_ROLE_MAP(ROLE_SEQ, USER_SEQ, PRNT_ORD, DEL_YN, CRE_DT, CREATOR_SEQ, UPD_DT, UPDATOR_SEQ) VALUES(101, 102, 1, 'N', NOW(), 100, NOW(), 100);
...
INSERT INTO CM_USER_ROLE_MAP(ROLE_SEQ, USER_SEQ, PRNT_ORD, DEL_YN, CRE_DT, CREATOR_SEQ, UPD_DT, UPDATOR_SEQ) VALUES(104, 102, 1, 'N', NOW(), 100, NOW(), 100);
...
INSERT INTO CM_MENU (MENU_SEQ, UP_MENU_SEQ, MENU_PATH, MENU_NM, MENU_DESC, CM_SCREN_YN, PRNT_YN, PRNT_ORD, DEL_YN, CRE_DT, CREATOR_SEQ, UPD_DT, UPDATOR_SEQ) VALUES (2110, 2000, '/todo/today_todo_plan', '오늘의 계획', '오늘의 계획', 'N', 'Y', 1, 'N', NOW(), 100, NOW(), 100);
INSERT INTO CM_MENU (MENU_SEQ, UP_MENU_SEQ, MENU_PATH, MENU_NM, MENU_DESC, CM_SCREN_YN, PRNT_YN, PRNT_ORD, DEL_YN, CRE_DT, CREATOR_SEQ, UPD_DT, UPDATOR_SEQ) VALUES (2120, 2000, '/todo/todo_settle',     'TODO 정산', 'TODO 정산', 'N', 'Y', 2, 'N', NOW(), 100, NOW(), 100);
INSERT INTO CM_MENU (MENU_SEQ, UP_MENU_SEQ, MENU_PATH, MENU_NM, MENU_DESC, CM_SCREN_YN, PRNT_YN, PRNT_ORD, DEL_YN, CRE_DT, CREATOR_SEQ, UPD_DT, UPDATOR_SEQ) VALUES (2130, 2000, '/todo/todo_mgt',        'TODO 관리', 'TODO 관리', 'N', 'Y', 3, 'N', NOW(), 100, NOW(), 100);
INSERT INTO CM_MENU (MENU_SEQ, UP_MENU_SEQ, MENU_PATH, MENU_NM, MENU_DESC, CM_SCREN_YN, PRNT_YN, PRNT_ORD, DEL_YN, CRE_DT, CREATOR_SEQ, UPD_DT, UPDATOR_SEQ) VALUES (2140, 2000, '/todo/todo_quiz_mgt',   '문제 관리', '문제 관리', 'N', 'Y', 4, 'N', NOW(), 100, NOW(), 100);

INSERT INTO CM_MENU (MENU_SEQ, UP_MENU_SEQ, MENU_PATH, MENU_NM, MENU_DESC, CM_SCREN_YN, PRNT_YN, PRNT_ORD, DEL_YN, CRE_DT, CREATOR_SEQ, UPD_DT, UPDATOR_SEQ) VALUES (2210, 2000, '/action/today_action',       '오늘의 할일', '오늘의 할일', 'N', 'Y', 1, 'N', NOW(), 100, NOW(), 100);
INSERT INTO CM_MENU (MENU_SEQ, UP_MENU_SEQ, MENU_PATH, MENU_NM, MENU_DESC, CM_SCREN_YN, PRNT_YN, PRNT_ORD, DEL_YN, CRE_DT, CREATOR_SEQ, UPD_DT, UPDATOR_SEQ) VALUES (2220, 2000, '/action/choice_todo_item',   'TODO 선택', 'TODO 선택', 'N', 'Y', 2, 'N', NOW(), 100, NOW(), 100);
INSERT INTO CM_MENU (MENU_SEQ, UP_MENU_SEQ, MENU_PATH, MENU_NM, MENU_DESC, CM_SCREN_YN, PRNT_YN, PRNT_ORD, DEL_YN, CRE_DT, CREATOR_SEQ, UPD_DT, UPDATOR_SEQ) VALUES (2230, 2000, '/action/actor_todo_history', 'TODO 이력', 'TODO 이력', 'N', 'Y', 3, 'N', NOW(), 100, NOW(), 100);
INSERT INTO CM_MENU (MENU_SEQ, UP_MENU_SEQ, MENU_PATH, MENU_NM, MENU_DESC, CM_SCREN_YN, PRNT_YN, PRNT_ORD, DEL_YN, CRE_DT, CREATOR_SEQ, UPD_DT, UPDATOR_SEQ) VALUES (2240, 2000, '/action/actor_point_settle', '포인트 정산', '포인트 정산', 'N', 'Y', 4, 'N', NOW(), 100, NOW(), 100);
